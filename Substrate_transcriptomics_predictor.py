...
X_target = []
data_list = []
data_file = open('Data/Substrate_transcriptomics_predictor_data.txt', 'r')
...
model = load_model('Model/Substrate_transcriptomics_predictor_model.h5')
...
auc_curve(X_target, total_score, 'Substrate_transcriptomics_predictor_model', total_auc)
print("Substrate_transcriptomics_predictor_model AUC : ", total_auc)