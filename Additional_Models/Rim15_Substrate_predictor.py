...
Pho_data = open('Data/Rim15_Substrate_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Rim15_Substrate_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Rim15_Substrate_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Rim15_Substrate_predictor_model', total_auc)
print("Rim15_Substrate_predictor_model AUC : ", total_auc)
