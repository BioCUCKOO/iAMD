...
X_target = []
data_list = []
data_file = open('Data/Slt2_PPI_PseAAC_predictor_data.txt', 'r')
...
model = load_model('Model/Slt2_PPI_PseAAC_predictor_model.h5')
...
auc_curve(X_target, total_score, 'Slt2_PPI_PseAAC_predictor_model', total_auc)
print("Slt2_PPI_PseAAC_predictor_model AUC : ", total_auc)
