...
Pho_data = open('Data/Gcn2_PPI_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Gcn2_PPI_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Gcn2_PPI_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Gcn2_PPI_predictor_model', total_auc)
print("Gcn2_PPI_predictor_model AUC : ", total_auc)
