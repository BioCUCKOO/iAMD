...
Pho_data = open('Data/TORC1_Substrate_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/TORC1_Substrate_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/TORC1_Substrate_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'TORC1_Substrate_predictor_model', total_auc)
print("TORC1_Substrate_predictor_model AUC : ", total_auc)
