...
X_target = []
data_list = []
data_file = open('Data/Gcn2_Substrate_phosphoproteomics_predictor_data.txt', 'r')
...
model = load_model('Model/Gcn2_Substrate_phosphoproteomics_predictor_model.h5')
...
auc_curve(X_target, total_score, 'Gcn2_Substrate_phosphoproteomics_predictor_model', total_auc)
print("Gcn2_Substrate_phosphoproteomics_predictor_model AUC : ", total_auc)