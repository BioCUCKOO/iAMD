...
Pho_data = open('Data/Npr1_PPI_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Npr1_PPI_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Npr1_PPI_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Npr1_PPI_predictor_model', total_auc)
print("Npr1_PPI_predictor_model AUC : ", total_auc)
