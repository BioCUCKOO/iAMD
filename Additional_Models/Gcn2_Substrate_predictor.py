...
Pho_data = open('Data/Gcn2_Substrate_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Gcn2_Substrate_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Gcn2_Substrate_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Gcn2_Substrate_predictor_model', total_auc)
print("Gcn2_Substrate_predictor_model AUC : ", total_auc)
