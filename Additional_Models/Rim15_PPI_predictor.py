...
Pho_data = open('Data/Rim15_PPI_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Rim15_PPI_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Rim15_PPI_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Rim15_PPI_predictor_model', total_auc)
print("Rim15_PPI_predictor_model AUC : ", total_auc)
