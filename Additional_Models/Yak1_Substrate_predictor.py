...
Pho_data = open('Data/Yak1_Substrate_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/Yak1_Substrate_PseAAC_predictor_result.txt', 'r')
...
lr = joblib.load('Model/Yak1_Substrate_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'Yak1_Substrate_predictor_model', total_auc)
print("Yak1_Substrate_predictor_model AUC : ", total_auc)
