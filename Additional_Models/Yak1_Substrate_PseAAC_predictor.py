...
X_target = []
data_list = []
data_file = open('Data/Yak1_Substrate_PseAAC_predictor_data.txt', 'r')
...
model = load_model('Model/Yak1_Substrate_PseAAC_predictor_model.h5')
...
auc_curve(X_target, total_score, 'Yak1_Substrate_PseAAC_predictor_model', total_auc)
print("Yak1_Substrate_PseAAC_predictor_model AUC : ", total_auc)