...
X_target = []
data_list = []
data_file = open('Data/Rim15_Substrate_phosphoproteomics_predictor_data.txt', 'r')
...
model = load_model('Model/Rim15_Substrate_phosphoproteomics_predictor_model.h5')
...
auc_curve(X_target, total_score, 'Rim15_Substrate_phosphoproteomics_predictor_model', total_auc)
print("Rim15_Substrate_phosphoproteomics_predictor_model AUC : ", total_auc)