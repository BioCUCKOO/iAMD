...
Pro_data = open('Data/PPI_proteomics_predictor_result.txt', 'r')
Rna_data = open('Data/PPI_transcriptomics_predictor_result.txt', 'r')
Pho_data = open('Data/PPI_phosphoproteomics_predictor_result.txt', 'r')
Pse_data = open('Data/PPI_sequence_predictor_result.txt', 'r')
...
lr = joblib.load('Model/PPI_predictor_model.pkl')
...
auc_curve(X_target, total_score, 'PPI_predictor_model', total_auc)
print("PPI_predictor_model AUC : ", total_auc)
