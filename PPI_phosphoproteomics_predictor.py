...
X_target = []
data_list = []
data_file = open('Data/PPI_phosphoproteomics_predictor_data.txt', 'r')
...
model = load_model('Model/PPI_phosphoproteomics_predictor_model.h5')
...
auc_curve(X_target, total_score, 'PPI_phosphoproteomics_predictor_model', total_auc)
print("PPI_phosphoproteomics_predictor_model AUC : ", total_auc)
